...
class Rainbow extends RGB {
    ...
    init() {
        this.id.addEventListener('click', this.startLoop.bind(this, this.rgb, this.nextColor))
    }
    ...
    startLoop() {
        ...
        this.timer = setInterval(() => {
            if(this.rgb.r === 255 && this.rgb.g === 0 && this.rgb.b === 0) this.nextColor = 'orange'
            switch (this.nextColor) {
            // Switch statement for switching colors/updating rgb values
                case 'orange':
                    if (this.rgb.r === 255 && this.rgb.g === 127 && this.rgb.b === 0) {
                    ...
                    break;
                case 'yellow':
                    if(this.rgb.r === 255 && this.rgb.g === 255 && this.rgb.b === 0) {
                    ...
                    break;
                case 'green':
                    if(this.rgb.r === 0 && this.rgb.g === 255 && this.rgb.b === 0) {
                        this.nextColor = 'blue'
                    } else {
                        this.rgb.r--
                        this.id.style.backgroundColor = `rgb(${this.rgb.r},${this.rgb.g},${this.rgb.b})`
                    ...
                    break;
                case 'blue':
                    if(this.rgb.r === 0 && this.rgb.g === 0 && this.rgb.b === 255) {
                    ...
                    break;
                case 'indigo':
                    if (this.rgb.r === 75 && this.rgb.g === 0 && this.rgb.b === 130) {
                    ...
                    break;
                case 'violet':
                    if (this.rgb.r === 148 && this.rgb.g === 0 && this.rgb.b === 211) {
                        this.nextColor = 'red'
                    } else {
                        if (this.rgb.r !== 148) {
                            this.rgb.r++
